...
- Речь отражает на бизнес-аспекты задач.
...
- Вопросы и проблемы, которые не решаются на дейли попадают в специальный список - Якорь (тянет команду на дно). Задача PM - держать Якорь пустым. PM в свою речь включает так же и обновления Якоря.
